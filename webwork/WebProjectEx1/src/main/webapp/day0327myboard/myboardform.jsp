			...
			<table class="table table-bordered" style="width: 600px;">
				...
				<tr class="table-primary">
					...
					<td><input type="text" name="writer" class="form-control"
						style="width: 120px;" autofocus="autofocus" required="required">
					</td>
				</tr>
				<tr class="table-primary">
				...
				<tr class="table-primary">
					<td colspan="2">
						<button type="submit" class="btn btn-outline-primary" style="margin-left:200px;">저장하기</button>
