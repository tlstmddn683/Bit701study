...
<body>
	<div style="margin:30px;width:500px;">
		...
		<td><input type="text" name="carname" class="form-control" style="width:200px;"></td>
		</tr>
		<tr>
		<th style="background-color:#ddd;width:100px;">자동차색상</th>
		<td><input type="color" name="carcolor" class="form-control" style="width:100px;" value="#ffccab"></td>
		</tr>
		<tr>
		<th style="background-color:#ddd;width:100px;">자동차가격</th>
		<td><input type="text" name="carprice" class="form-control" style="width:200px;"></td>
		</tr>
		<tr>
